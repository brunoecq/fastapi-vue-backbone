        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="身份证" prop="identity_card">
              <el-input v-model="form.identity_card" placeholder="请输入身份证" maxlength="18" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
  ...
  methods: {
    ...
    handleAdd() {
      ...
      getUser().then(response => {
        this.postOptions = response.data.postOptions
    ...
    handleFileSuccess(response, file, fileList) {
      ...
      this.$alert(response.detail || response.message, '导入结果', { dangerouslyUseHTMLString: true })
      this.getList()
    },
    // 提交上传文件
    submitFileForm() {
